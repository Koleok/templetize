...
//   });
//
//   describe('when the templatize:convert event is triggered', () => {
...
//
//         const templatizeElement = workspaceElement.querySelector('.templatize');
//         expect(templatizeElement).toExist();
//
//         const templatizePanel = atom.workspace.panelForItem(templatizeElement);
